...
wget https://github.com/SagerNet/sing-box/releases/download/v1.13.21/sing-box_v1.13.21_linux_amd64.deb > /dev/null 2>&1
sudo dpkg -i sing-box_v1.13.21_linux_amd64.deb > /dev/null 2>&1
